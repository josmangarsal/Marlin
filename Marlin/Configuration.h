...
#define STRING_CONFIG_H_AUTHOR "(josman, ANET A6 MKII Turbo config)" // Who made the changes.
...
/*
  Use 3 for SKR 1.4 WiFi onBoard
  Go to .platformio/packages/framework-arduino-lpc176x/cores/arduino/HardwareSerial.h and edit UART3 to
  PinCfg.Funcnum = 3;
  PinCfg.OpenDrain = 0;
  PinCfg.Pinmode = 0;
  PinCfg.Pinnum = 28; // WiFi PIN
  PinCfg.Portnum = 4; // I don't know why xD
  PINSEL_ConfigPin(&PinCfg);
  PinCfg.Pinnum = 29; // WiFi PIN
  PINSEL_ConfigPin(&PinCfg);
*/
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // TFT35 + WiFi
...
#define CUSTOM_MACHINE_NAME "Anet A6 MKII Turbo"
 ...
 */
#define TEMP_SENSOR_0 5 // Fake E3D
...
#define TEMP_SENSOR_BED 11 // Anet A6
...
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  100, 400, 95 } // Direct Anet A6
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  100, 400, 391.5 } // Bownden Fake Titan
...
// It's ok, P0_10 is defined in pins_BTT_SKR_V1_4.h
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 9, 55, -1.2 }
...
#define INVERT_Y_DIR false // Anet A6
#define INVERT_Z_DIR true // Anet A6

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true // Inverted fake Titan extruder
...
#define X_MIN_POS 0 // Default Anet A6 is -3
#define Y_MIN_POS 0 // Default Anet A6 is -5
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 230 // Anet A6
 ...
 */
#define NOZZLE_PARK_FEATURE // Filament change
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 21       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
